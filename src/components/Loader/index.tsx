...
export const Loader = ({ size = 48, className = "" }: LoaderProps) => {
  ...
  return (
    <div
      className={`m-auto relative ${className}`}
      style={{ width: size, height: size }}
    >
      <motion.div
        className="align-left absolute"
        style={{ width: size, height: size }}
        animate={{ rotate: 360 }}
